...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    _phoneController = TextEditingController(text: _initialUserData['phoneNumber']);
  ...
  Widget _buildSwitchSettingsSection() { return _buildSectionContainer(children: [ _buildSwitchItem(iconAssetPathOrData: Icons.notifications_active_outlined, title: AppStrings.pushNotification, value: _pushNotification, onChanged: (val) => setState(() => _pushNotification = val)), _buildSwitchItem(iconAssetPathOrData: Icons.dark_mode_outlined, title: AppStrings.darkMode, value: _darkMode, onChanged: (val) => setState(() => _darkMode = val)), _buildSwitchItem(iconAssetPathOrData: Icons.volume_up_outlined, title: AppStrings.sound, value: _sound, onChanged: (val) => setState(() => _sound = val)), _buildSwitchItem(iconAssetPathOrData: Icons.update_outlined, title: AppStrings.automaticallyUpdated, value: _automaticallyUpdated, onChanged: (val) => setState(() => _automaticallyUpdated = val), hasDivider: false), ],); }
  Widget _buildSwitchItem({required dynamic iconAssetPathOrData, required String title, required bool value, required ValueChanged<bool> onChanged, bool hasDivider = true}) { Widget leadingIcon; if (iconAssetPathOrData is IconData) { leadingIcon = Icon(iconAssetPathOrData, color: AppColors.neutral700, size: AppResponsive.width(22)); } else if (iconAssetPathOrData is String) { if (iconAssetPathOrData.toLowerCase().endsWith('.svg')) { leadingIcon = Image.asset(iconAssetPathOrData, color: AppColors.neutral700, width: AppResponsive.width(22), height: AppResponsive.width(22)); } else { leadingIcon = Image.asset(iconAssetPathOrData, color: AppColors.neutral700, width: AppResponsive.width(22), height: AppResponsive.width(22)); } } else { leadingIcon = SizedBox(width: AppResponsive.width(22)); } return Column(children: [ ListTile(leading: leadingIcon, title: Text(title, style: _textStyles.regular(color: AppColors.textPrimary, fontSize: 14)), trailing: Switch(value: value, onChanged: onChanged, activeColor: AppColors.primary500, inactiveThumbColor: AppColors.neutral300, inactiveTrackColor: AppColors.neutral200.withOpacity(0.5), activeTrackColor: AppColors.primary500.withOpacity(0.4), materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,), contentPadding: EdgeInsets.only(left: AppResponsive.width(16), right:AppResponsive.width(8), top: AppResponsive.height(2), bottom: AppResponsive.height(2)), dense: true,), if(hasDivider) Divider(height: 0.5, indent: AppResponsive.width(16+22+16.0), color: AppColors.neutral100, thickness: 0.5,) ],); }
}